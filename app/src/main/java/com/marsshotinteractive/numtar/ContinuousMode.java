...
public class ContinuousMode extends AppCompatActivity{
    ...
    private int numOfGoalNumberHit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarModeTextView.setText("Continuous Mode");
        numOfGoalNumberHit = 0;
        generateGoalNumber();
        ...
        countDownTimer = new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                ...
                builder.setTitle("Time is up")
                        .setMessage("You hit " + numOfGoalNumberHit + " target numbers in 60 seconds")
                        .setCancelable(false)
    ...
    private void goBackToHome()
    {
        ...
        Intent homeIntent = new Intent(ContinuousMode.this, Numtar.class);
